...
def rotation_detection_dlib(img, mode, show=False):
    ...
    predictor = dlib.shape_predictor('../Pre_processing/shape_predictor_5_face_landmarks.dat')
...
def rotation_detection_opencv(img, mode, show=False):
    nose_cascade = cv2.CascadeClassifier('../Pre_processing/haarcascade_mcs_nose.xml')
    eyes_cascade = cv2.CascadeClassifier('../Pre_processing/haarcascade_eye.xml')
    fase_cascade = cv2.CascadeClassifier('../Pre_processing/haarcascade_frontalface_default.xml')
...
#Pre_process va data_path la original folder, sau do la cac Emotional folders, cuoi cung la imgs.
#data_path la folder nguon, Pre_process la facial_correction_fd

data_path ='data/train'
data_dir_list = os.listdir(data_path)

#Tao folder  facial_correction_fd
img_data_list=[]
Pre_process ='../data_af_preprocessing/Facial_correction_data/train'
