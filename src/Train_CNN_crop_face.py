...
train_dir = 'data_af_preprocessing/Cropped_facial_data/train'
val_dir = 'data_af_preprocessing/Cropped_facial_data//test'
#PARAMETER
...
if mode == "train":
    ...
    model.save('Model/CNN_crop_face_model.h5')
    #Ket qua train, val
    model.evaluate(train_generator)
    model.evaluate(validation_generator)
    # emotions will be displayed on your face from the webcam feed
elif mode == "display":
    model.load_weights('Model/CNN_crop_face_weight.h5')
...
#reload model
reloaded_model = tf.keras.models.load_model("Model/CNN_crop_face_model.h5")
...
plt.tight_layout()
plt.savefig('../imgs/crop_face_matrix.png')
print("done")
